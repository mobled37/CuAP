...
t_0=500
audio_intensity=3
edit_attr=CuAP_thunder

python main.py --optimization          \
--config /data/kylee/projects/sound-guided-semantic-image-manipulation/configs/custom.yml    \
...
--comment ${edit_attr}  \
--exp ./runs/Main_${edit_attr}_sound1_ai${aud io_intensity}_cl${clip_weight}_id${id_weight}_l2${l2_weight}_sl${soundclip_weight}_vgg${vgg_weight}_niter${n_iter}_for${S_for}_gen${S_gen}      \
--edit_attr ${edit_attr} \
...
--model_path /data/kylee/projects/sound-guided-semantic-image-manipulation/pretrained/diffusionclip/church_outdoor.ckpt \
--comment ${edit_attr}  \
--exp ./runs/Main_${edit_attr}_sound1_ai${audio_intensity}_cl${clip_weight}_id${id_weight}_l2${l2_weight}_sl${soundclip_weight}_vgg${vgg_weight}_niter${n_iter}_for${S_for}_gen${S_gen}      \
--edit_attr ${edit_attr} \
--audio_encoder_path soundclip/pretrained/audio_encoder/audio_encoder49.pth \
--results_dir ./results/exp10 \
--do_train 1             \
